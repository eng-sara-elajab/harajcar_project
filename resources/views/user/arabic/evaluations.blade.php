...
@section('content')
    <div class="row" style="margin-bottom: 20px; margin-top: 20px">
        <div class="col-md-2 col-md-offset-5 col-xs-2 col-xs-offset-8">
            <a href="/user/evaluate/{{$user->id}}" class="btn btn-lg btn-default"><p style="text-align: center; font-family: 'Segoe UI'; color: #0275d8">إضافة تقييم</p></a><br><br><br>
        </div><br><br>
        ...
        @else
            <div class="col-md-2 col-md-offset-5 col-xs-4 col-xs-offset-4" style="margin-bottom: 15%">
                <h6 style="text-align: left">لا توجد تقييمات</h6>
            </div>
        @endif
    </div>
@endsection