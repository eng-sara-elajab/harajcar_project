...
<html lang="en">
    ...
    <body>
        <nav class="topnav navbar bg-info" id="myTopnav" style="text-align: center">
        ...
        <footer class="site-footer">
            <div class="container-fluid">
                ...
                <p style="color:white; text-align: center; font-size: 12px">All rights reserved 2020 - {{ now()->year }}</p>
            </div>
