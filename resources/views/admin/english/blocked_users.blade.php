                ...
                @if(count($users) > 0)
                    ...
                    <table class="table table-responsive" style="margin-top: 15px; text-align: center">
                        <tr style="font-size: 20px; font-weight: bold">
                            ...
                            <th style="border:1px solid black;border-collapse:collapse; text-align: center">صورة الغلاف</th>
                            <th style="border:1px solid black;border-collapse:collapse; text-align: center">عدد المتابعين</th>
                            <th style="border:1px solid black;border-collapse:collapse; text-align: center">المتابعات</th>
                        ...
                        @foreach($users as $user)
                            <tr style="text-align: center">
                                ...
                                <td><img src="/images/covers/{{$user->cover_photo}}" style="height:50px; width: 50px"></td>
                                <td>{{$user->followers}}</td>
                                <td>{{$user->follownig}}</td>
