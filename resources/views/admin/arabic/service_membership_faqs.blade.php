    ...
    <section class="content">
        <div class="container-fluid row">
            <div class="col-xl-8 offset-xl-2 col-lg-8 offset-lg-2 col-md-8 offset-md-2 col-sm-10 offset-sm-1 col-12">
                ...
                @endif
                <form class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" method="post" action="/admin/store_service_membership_faq">
                    @csrf
                        ...
                        @foreach($service_membership_faqs as $service_membership_faq)
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <p style="text-align: right; font-size: 16px; font-family: 'Segoe UI'; color: darkgrey">{{$service_membership_faq->question}}</p>
                                </div>
                                <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-10">
                                    <p style="text-align: right; font-size: 14px; font-family: 'Segoe UI'; color: #24a0ed; margin-right: 20px">{{$service_membership_faq->answer}}</p>
                                </div>
                                <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-1">
                                    <a href="/admin/delete_service_membership_faq/{{$service_membership_faq->id}}" class="pull-left" style="margin-left: 15px"><i class="fa fa-minus-circle" style="color: red"></i></a>
                                </div>
                            </div>
                            <hr>
                        @endforeach
