    ...
    <section class="content">
        <div class="container-fluid row">
            <div class="col-xl-8 offset-xl-2 col-lg-8 offset-lg-2 col-md-8 offset-md-2 col-sm-10 offset-sm-1 col-10 offset-1">
                ...
                @endif
                <form class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" method="post" action="/admin/store_rating_acceptance_term">
                    @csrf
                    <label class="pull-right" style="text-align: right; font-size: 20px; font-family: 'Segoe UI'; color: black; margin-bottom: 3%; opacity: 0.5">: أضف شرط جديد لقبول التقييم</label>
                ...
                @if(count($rating_acceptance_terms) > 0)
                    <ul dir="rtl" style="margin-top: 5%">
                        @foreach($rating_acceptance_terms as $rating_acceptance_term)
                            <li style="text-align: right; font-size: 18px; font-family: 'Segoe UI'; color: darkgrey" class="row">
                                <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-10">{{$rating_acceptance_term->body}}</div>
                                <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-1">
                                    <a href="/admin/delete_rating_acceptance_term/{{$rating_acceptance_term->id}}" class="pull-left" style="margin-left: 30%"><i class="fa fa-minus-circle" style="color: red"></i></a>
                                </div>
                            </li>
                            <hr>
                        @endforeach
                ...
                @else
                    <br><h3 style="color: darkorange; text-align: center">لا توجد شروط لقبول التقييم حتى الآن</h3>
                @endif
            </div>
        </div>
    </section>
