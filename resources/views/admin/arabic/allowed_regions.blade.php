    ...
    <section class="content">
        <div class="container-fluid row">
            <div class="col-xl-8 offset-xl-2 col-lg-8 offset-lg-2 col-md-8 offset-md-2 col-sm-10 offset-sm-1 col-10 offset-1">
                ...
                @endif
                <form class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" method="post" action="/admin/store_region">
                    @csrf
                ...
                @if(count($allowed_regions) > 0)
                    <ul dir="rtl" style="margin-top: 5%" class="row">
                        @foreach($allowed_regions as $region)
                            <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 col-5">
                                <p style="text-align: right; font-size: 16px; font-family: 'Segoe UI'; color: #24a0ed">{{$region->arabic_name}}</p>
                            </div>
                            <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 col-5">
                                <p style="text-align: right; font-size: 16px; font-family: 'Segoe UI'; color: #24a0ed">{{$region->english_name}}</p>
                            </div>
                            <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-1">
                                <p style="text-align: right; font-size: 16px; font-family: 'Segoe UI'; color: darkgrey"><a href="/admin/delete_region/{{$region->id}}" class="pull-left" style="margin-left: 35px; text-align: left"><i class="fa fa-minus-circle" style="color: red"></i></a></p>
                            </div>
                    ...
                    {{$allowed_regions->links()}}
                @else
                    <br><h3 style="color: darkorange; text-align: center">لا توجد مدن مدخلة حتى الآن</h3>
                @endif
            </div>
        </div>
    </section>
