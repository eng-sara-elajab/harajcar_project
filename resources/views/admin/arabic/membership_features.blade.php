    ...
    <section class="content">
        <div class="container-fluid row">
            <div class="col-xl-8 offset-xl-2 col-lg-8 offset-lg-2 col-md-8 offset-md-2 col-sm-10 offset-sm-1 col-10 offset-1">
                ...
                @endif
                <form class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" method="post" action="/admin/store_membership_feature">
                    @csrf
                    <h5 class="pull-right" style="text-align: right; font-family: 'Segoe UI'; color: black; margin-bottom: 3%; opacity: 0.5">: أضف ميزة جديدة لعضوية الموقع</h5>
                    ...
                    <p style="color: darkgrey; font-size: 13px; text-align: right">الميزة يجب أن يكون مكتوب بصيغة واضحة ومفهومة وبعيدة عن اللبس<span style="color: darkorange; font-size: 16px">*</span></p>
                    ...
                    <ul dir="rtl" style="margin-top: 5%">
                        @foreach($membership_features as $membership_feature)
                            <li style="text-align: right; font-size: 18px; font-family: 'Segoe UI'; color: darkgrey" class="row">
                                <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-10">{{$membership_feature->body}}</div>
                                <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-1">
                                    <a href="/admin/delete_membership_feature/{{$membership_feature->id}}" class="pull-left" style="margin-left: 10%"><i class="fa fa-minus-circle" style="color: red"></i></a>
                                </div>
                            </li>
                            <hr>
                        @endforeach
                    </ul>
                    {{$membership_features->links()}}
                @else
                    <br><h3 style="color: darkorange; text-align: center">لا توجد مزايا للعضوية إلى الآن</h3>
                @endif
            </div>
        </div>
    </section>
